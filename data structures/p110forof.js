...
for (const characters of fantasticFour) {
  console.log(characters);
}
for (const characters of fantasticFour.entries()) {
  console.log(characters);
}
for (const [i, el] of fantasticFour.entries()) {
  console.log(`Character #${i + 1}: The ${el}`);
}
// Avengers example
const avengersTeam = [
  'Black Widow',
...
for (const [i, el] of avengersTeam.entries()) {
  console.log(`Avenger #${i + 1}: The ${el}`);
}

const countries = ['Pakistan', 'India', 'Afghanistan', 'US'];
for (let country of countries) {
  console.log(`I would effing love to visit ${country}`);
}
